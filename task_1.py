...
# Збір та передача шляхів до файлів з каталогу та підкаталогів
...
# Копіювання файлів згідно з їхнім розширенням до відповідних підкаталогів
async def copy_file(file: aiopath.AsyncPath):
    folder = to_dir / file.suffix[1:]
    try:
        await папка.mkdir(parents=True, exist_ok=True)
...
if __name__ == "__main__":
    ...
    print(f"Files have been replicated from the directory '{from_dir}' to '{to_dir}'.")
